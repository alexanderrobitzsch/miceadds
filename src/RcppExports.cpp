...
arma::colvec miceadds_rcpp_rtnorm(Rcpp::IntegerVector y, arma::colvec mu, arma::colvec sigma, arma::colvec lower, arma::colvec upper);
static SEXP _miceadds_miceadds_rcpp_rtnorm_try(SEXP ySEXP, SEXP muSEXP, SEXP sigmaSEXP, SEXP lowerSEXP, SEXP upperSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(miceadds_rcpp_rtnorm(y, mu, sigma, lower, upper));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _miceadds_miceadds_rcpp_rtnorm(SEXP ySEXP, SEXP muSEXP, SEXP sigmaSEXP, SEXP lowerSEXP, SEXP upperSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_miceadds_miceadds_rcpp_rtnorm_try(ySEXP, muSEXP, sigmaSEXP, lowerSEXP, upperSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static int _miceadds_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("arma::colvec(*miceadds_rcpp_rtnorm)(Rcpp::IntegerVector,arma::colvec,arma::colvec,arma::colvec,arma::colvec)");
    }
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_miceadds_miceadds_rcpp_rtnorm", (DL_FUNC) &_miceadds_miceadds_rcpp_rtnorm, 5},
