...
Rcpp::List miceadds_rcpp_create_interactions(Rcpp::NumericVector Yr, Rcpp::NumericMatrix Xr, Rcpp::NumericMatrix Xallr, Rcpp::NumericMatrix index_int, Rcpp::NumericVector MI, Rcpp::NumericVector maxcols);
RcppExport SEXP _miceadds_miceadds_rcpp_create_interactions(SEXP YrSEXP, SEXP XrSEXP, SEXP XallrSEXP, SEXP index_intSEXP, SEXP MISEXP, SEXP maxcolsSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(miceadds_rcpp_create_interactions(Yr, Xr, Xallr, index_int, MI, maxcols));
...
static const R_CallMethodDef CallEntries[] = {
    {"_miceadds_miceadds_rcpp_create_interactions", (DL_FUNC) &_miceadds_miceadds_rcpp_create_interactions, 6},
    {"_miceadds_kernelplsaux", (DL_FUNC) &_miceadds_kernelplsaux, 3},
    {"_miceadds_kernelpls_1dim_C", (DL_FUNC) &_miceadds_kernelpls_1dim_C, 3},
    {"_miceadds_miceadds_rcpp_ml_mcmc_sampler", (DL_FUNC) &_miceadds_miceadds_rcpp_ml_mcmc_sampler, 30},
