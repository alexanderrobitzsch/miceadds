...
miceadds_rcpp_create_interactions <- function(Yr, Xr, Xallr, index_int, MI, maxcols) {
    .Call('_miceadds_miceadds_rcpp_create_interactions', PACKAGE='miceadds', Yr, Xr, Xallr, index_int, MI, maxcols)
}
