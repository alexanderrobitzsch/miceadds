## File Name: miceadds_create_contextual_variables.R
## File Version: 1.04


miceadds_create_contextual_variables <- function( y, ry, x, type, ...)
{
...
.a2l.contextual.auxiliary <- miceadds_create_contextual_variables
